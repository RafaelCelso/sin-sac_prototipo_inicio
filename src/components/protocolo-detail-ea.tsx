      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`inline-flex items-center gap-1 rounded-full px-3 py-0.5 text-xs font-medium ${isDark ? "bg-white/5 border border-white/10 text-gray-300" : "bg-[#F1F5F9] border border-[#91A2BA] text-gray-700"}`}><MapPin size={12} />{territorio}</span>
          </div>
        </div>
